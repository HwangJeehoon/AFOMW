...
gaitPct.SAH03 = [-10, 60, 90]; % 이러면 -10~0은 잘라서 뒷 파일에 붙이게 됨 -> processTrialCycles에서 처리
gaitPct.SAH04 = [-10, 60, 90]; % 이러면 -10~0은 잘라서 뒷 파일에 붙이게 됨 -> processTrialCycles에서 처리
...
% targets = struct( ...
%     'subject', {'SAH01', 'SAH01', 'SAH03', 'SAH04', 'SAH04', 'SAH04'}, ...
%     'dateStr', {'260706', '260713', '260623', '260728', '260804', '260811'});

targets = struct( ...
    'subject', {'SAH04', 'SAH04', 'SAH04'}, ...
    'dateStr', {'260728', '260804', '260811'});
%% ── 실행 ──────────────────────────────────────────────────────────
